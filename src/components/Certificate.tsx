...
export default function Certificate({ displayName, completedLessons, totalLessons, bestExamScore }: Props) {
  const { t } = useLanguage();
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      pdf.save('linux-study-certificate.pdf');
    } catch (err) {
  ...
  const downloadPNG = async () => {
    ...
    try {
      ...
      link.download = 'linux-study-certificate.png';
          ...
          <div className="cert-border-outer">
            <div className="cert-border-inner">
              <div className="cert-content">
                <p className="cert-site-name">Linux Study</p>
                ...
                <div className="cert-stats">
                  <div className="cert-stat">
                    ...
                    <span className="cert-stat-label">{t('certCompletedLessons')}</span>
                  </div>
                  <div className="cert-stat">
                  ...
                  {bestExamScore != null && (
                    <div className="cert-stat">
                      ...
                      <span className="cert-stat-label">{t('certBestExam')}</span>
                    </div>
                  )}
                  <div className="cert-stat">
