...
const Grade1P3Ch1 = () => {
  ...
  return (
    <>
      <SEOHead
        title="1급 실기 - 서버 구축 실무 - Linux Study"
        description="LAMP/LEMP 스택, SSL/TLS, 웹서버+DB 서버 구축 시나리오를 학습합니다."
      />

      <section className="page-header">
        <div className="container">
          <h1 className="page-title" data-aos="fade-up">실기 - 서버 구축 실무</h1>
          <p className="page-subtitle" data-aos="fade-up" data-aos-delay="100">
            LAMP/LEMP 스택, SSL/TLS 인증서, 웹서버+DB 서버 구축 시나리오 (고난도)
          </p>
        </div>
      </section>
      ...
      <div className="lesson-body container">
        ...
        <section className="lesson-section" data-aos="fade-up">
          <h2>1. LAMP 스택 구축</h2>
          <p>
            LAMP는 <strong>Linux + Apache + MySQL/MariaDB + PHP</strong>의 약자로,
            가장 전통적인 웹 서비스 스택입니다.
          </p>

          <div className="code-block">
            <div className="code-header">LAMP 스택 설치 (CentOS/Rocky Linux)</div>
            <pre>{`# 1. Apache 설치 및 시작
$ yum install httpd
...
$ rm /var/www/html/info.php`}</pre>
        ...
        <section className="lesson-section" data-aos="fade-up">
          <h2>2. LEMP 스택 구축</h2>
          <p>
            LEMP는 <strong>Linux + (E)Nginx + MySQL/MariaDB + PHP</strong>의 약자로,
            고성능 웹 서비스에 널리 사용됩니다.
          </p>

          <div className="code-block">
            <div className="code-header">LEMP 스택 설치 (Ubuntu)</div>
            <pre>{`# 1. Nginx 설치
$ apt update
$ apt install nginx
...
$ systemctl reload nginx`}</pre>
        ...
        <section className="lesson-section" data-aos="fade-up">
          <h2>3. SSL/TLS 인증서 설정</h2>

          <div className="code-block">
            <div className="code-header">자체 서명 인증서 생성 및 Apache 설정</div>
            <pre>{`# 자체 서명 인증서 생성 (테스트/개발 환경)
...
$ systemctl restart httpd`}</pre>
          ...
          <div className="code-block">
            <div className="code-header">Let's Encrypt 무료 인증서 (실무)</div>
            <pre>{`# Certbot 설치
  ...
  -noout -text -dates`}</pre>
        ...
        <section className="lesson-section" data-aos="fade-up">
          ...
          <div className="callout-box warning">
            <strong>시나리오 1: 웹 애플리케이션 서버 구축</strong><br />
            조건: CentOS 기반으로 다음 구성을 완성하세요.<br />
            - Nginx를 리버스 프록시로 사용 (80, 443 포트)<br />
            - 백엔드 Apache 서버 (8080 포트)<br />
            - MariaDB 데이터베이스<br />
            - SSL 인증서 적용<br />
            - 방화벽 설정
          </div>
          ...
          <div className="code-block">
            <div className="code-header">시나리오 1 풀이</div>
            <pre>{`# 1. Apache를 8080 포트로 설정
...
$ setsebool -P httpd_can_network_connect on`}</pre>
          ...
          <div className="callout-box warning">
            <strong>시나리오 2: 데이터베이스 백업 자동화</strong><br />
            조건: MariaDB의 webapp 데이터베이스를 매일 새벽 2시에 자동 백업하고,
            7일 이상된 백업 파일을 자동 삭제하는 스크립트를 작성하세요.
          </div>

          <div className="code-block">
            <div className="code-header">시나리오 2 풀이</div>
            <pre>{`#!/bin/bash
...
# cron 등록
$ crontab -e
0 2 * * * /usr/local/bin/db-backup.sh`}</pre>
          </div>
        </section>
        ...
        <section className="lesson-section" data-aos="fade-up">
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
            <Link to="/grade1/part3-ch2" className="btn btn-primary">실기 - 네트워크 보안 실무 &rarr;</Link>
