import{u as t,j as e,L as s}from"./index-C6bdw2PR.js";import{u as i}from"./useAOS-Dwtt9G6H.js";import{S as r}from"./SEOHead-CGGjEQkv.js";import{L as a}from"./LessonComplete-XKA_7hUt.js";const x=()=>{i();const{t:l}=t();return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"2급 1차 - 리눅스 기초 명령어 - Linux Study",description:"파일 관련 명령어, 텍스트 처리(grep, sed, awk), 압축/아카이브, 네트워크 기본 명령어를 학습합니다."}),e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h1",{className:"page-title","data-aos":"fade-up",children:"1차 - 리눅스 기초 명령어"}),e.jsx("p",{className:"page-subtitle","data-aos":"fade-up","data-aos-delay":"100",children:"파일 관련 명령어, 텍스트 처리, 압축 및 아카이브, 네트워크 기본 명령어"})]})}),e.jsxs("div",{className:"lesson-body container",children:[e.jsxs("section",{className:"lesson-section","data-aos":"fade-up",children:[e.jsx("h2",{children:"1. 파일 관련 명령어 상세"}),e.jsxs("div",{className:"code-block",children:[e.jsx("div",{className:"code-header",children:"파일 내용 확인 명령어"}),e.jsx("pre",{children:`# cat - 파일 내용 전체 출력
$ cat file.txt
